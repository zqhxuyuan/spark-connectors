...
/**
  * https://github.com/zeyuanxy/spark-hbase-bulk-loading
  *
  * !!!Not Test Yet!!!
  */
object HBaseBulkload {
  ...
  def toHBaseBulk(mapRdd: RDD[(Array[Byte], Map[String, Array[(String, (String, Long))]])],
                  conf: Configuration,
                  tableNameStr: String,
                  numFilesPerRegionPerFamily: Int = 1) = {
    ...
    toHBaseBulkWithFamilies(mapRdd, conf, tableNameStr, families.toArray, numFilesPerRegionPerFamily)
  }

  def toHBaseBulkWithFamilies(mapRdd: RDD[(Array[Byte], Map[String, Array[(String, (String, Long))]])],
                              conf: Configuration,
                              tableNameStr: String,
